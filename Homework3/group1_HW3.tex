...
\item Team Building
\begin{enumerate}
\item English and French.  We give the English a positive weight and French a negative weight.  We have the costs on the arcs.  Here we slightly changed the model of the MCNFP by introducing a negative to the objective function.  This cause the minimizer to return a maximum.

\includegraphics[width = .9\textwidth]{p1aflowdiagram.png}

Here is our model file:

{\small \VerbatimInput{group1_HW3_p1a.mod}}

Here is our data file:

{\small \VerbatimInput{group1_HW3_p1a.dat}}
